...
class _FriendRequestCardState extends State<FriendRequestCard> {
  ...
  void initState(){
    super.initState();
    FriendRequestCardState friendRequestCardState = 
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      key: _scaffoldKey,
      body: BlocBuilder<FriendRequestCardCubit, FriendRequestCardState>(
        bloc: _cubit,
            ...
            return Row(
              ...
              children: <Widget>[
                ...
                Column(
                  ...
                  children: <Widget>[
                    Text(state.name! , style: const TextStyle(fontSize: 16.0, fontWeight: FontWeight.bold)),
                    const SizedBox(height: 10.0),
                    Text(state.sameFriends.toString() + "bạn chung" , style: TextStyle(fontSize: 12.0, color: Colors.black.withOpacity(0.6))),
                    const SizedBox(height: 10.0),
                    Row(
              ...
              children: <Widget>[
                ...
                Column(
                  ...
                  children: <Widget>[
                    ...
                    Text("Các bạn đã trở thành bạn bè", style: TextStyle(fontSize: 12.0, color: Colors.black.withOpacity(0.6)))
                  ],
                )
              ],
            );
              ...
              children: <Widget>[
                ...
                Column(
                  ...
                  children: <Widget>[
                    ...
                    Text("Yêu cầu đã bị gỡ", style: TextStyle(fontSize: 12.0, fontWeight: FontWeight.normal, color: Colors.black.withOpacity(0.6)))
                  ],
                )
              ],
            );
              ...
              child: Padding(
                ...
                child: Column(
                  children: <Widget>[
                    Row(
                      children: <Widget>[
                        const Text('Lời mời kết bạn', style: TextStyle(fontSize: 21.0, fontWeight: FontWeight.bold)),

                        const SizedBox(width: 10.0),

                        Text(state.friendEntities!.length.toString(), style: const TextStyle(fontSize: 21.0, fontWeight: FontWeight.bold, color: Colors.red)),
                        ...
                        InkWell(
                          child: Container(
                            ...
                            child: const Text('Sắp xếp', style: TextStyle(color: Colors.blue, fontSize: 15.0)),
                          ),
                          onTap: () {
                    ...
                    //   ],)
                    FriendRequestCard(friendEntity: state.friendEntities!.first,)
                  ],
            )),
            ),
          );
